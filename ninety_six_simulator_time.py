...
print(f"Total games played: {'{:,}'.format(game_number)} ")
print(f"Player 1 wins: {'{:,}'.format(p1_wins)} ({round((p1_wins/game_number) * 100, 5)}%)") 
print(f"Player 2 wins: {'{:,}'.format(p2_wins)} ({round((p2_wins/game_number) * 100, 5)}%)") 
